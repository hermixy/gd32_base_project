...
int32_t         param_act_param_rs_all       (hal_frame_info_t *p_frame_info)
{
	uint8_t   ack = 0;
    rs_param_all();
	_send_ack(p_frame_info, (uint8_t *)&ack, sizeof(uint8_t));
    return 0;
}

REG_LINK_ACTION(PC_LINK_ID      , COMM_CMD_SET    , CMD_ID_GET_PARAM_CNT        , param_act_param_cnt);
REG_LINK_ACTION(PC_LINK_ID      , COMM_CMD_SET    , CMD_ID_GET_PARAM_ITEM       , param_act_param_item);
REG_LINK_ACTION(PC_LINK_ID      , COMM_CMD_SET    , CMD_ID_WR_PARAM_ITEM        , param_act_param_wr);
REG_LINK_ACTION(PC_LINK_ID      , COMM_CMD_SET    , CMD_ID_RD_PARAM_ITEM        , param_act_param_rd);
REG_LINK_ACTION(PC_LINK_ID      , COMM_CMD_SET    , CMD_ID_RS_PARAM_ITEM        , param_act_param_rs);
REG_LINK_ACTION(PC_LINK_ID      , COMM_CMD_SET    , CMD_ID_RS_ALL_PARAM_ITEM    , param_act_param_rs_all);

//REG_LINK_ACTION(UART4_LINK_ID      , COMM_CMD_SET    , CMD_ID_GET_PARAM_CNT        , param_act_param_cnt);
//REG_LINK_ACTION(UART4_LINK_ID      , COMM_CMD_SET    , CMD_ID_GET_PARAM_ITEM       , param_act_param_item);
//REG_LINK_ACTION(UART4_LINK_ID      , COMM_CMD_SET    , CMD_ID_WR_PARAM_ITEM        , param_act_param_wr);
//REG_LINK_ACTION(UART4_LINK_ID      , COMM_CMD_SET    , CMD_ID_RD_PARAM_ITEM        , param_act_param_rd);
//REG_LINK_ACTION(UART4_LINK_ID      , COMM_CMD_SET    , CMD_ID_RS_PARAM_ITEM        , param_act_param_rs);
//REG_LINK_ACTION(UART4_LINK_ID      , COMM_CMD_SET    , CMD_ID_RS_ALL_PARAM_ITEM    , param_act_param_rs_all);
