...
#define UART0_IRQ  					    5							
#define UART0_TX_BUF_SIZE  	            DEFAULT_BUF_SIZE	//use PROTOCOL_EF02_PLUS >  1024
#define UART0_RX_BUF_SIZE  	            DEFAULT_BUF_SIZE

#define UART1_IRQ  					    6
#define UART1_TX_BUF_SIZE  	            DEFAULT_BUF_SIZE					
#define UART1_RX_BUF_SIZE  	            DEFAULT_BUF_SIZE

#define UART2_IRQ  					    9
#define UART2_TX_BUF_SIZE  	            DEFAULT_BUF_SIZE					
